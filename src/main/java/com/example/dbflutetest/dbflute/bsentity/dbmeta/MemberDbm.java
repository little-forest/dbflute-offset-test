package com.example.dbflutetest.dbflute.bsentity.dbmeta;
...
public class MemberDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((Member)et).getId(), (et, vl) -> ((Member)et).setId(ctl(vl)), "id");
    ...
    protected final ColumnInfo _columnMemberName = cci("member_name", "member_name", null, null, String.class, "memberName", null, false, false, true, "VARCHAR", 20, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflutetest.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "com.example.dbflutetest.dbflute.cbean.MemberCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflutetest.dbflute.exbhv.MemberBhv"; }
