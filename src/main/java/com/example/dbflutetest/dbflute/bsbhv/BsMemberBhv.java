package com.example.dbflutetest.dbflute.bsbhv;
...
import com.example.dbflutetest.dbflute.bsbhv.loader.*;
import com.example.dbflutetest.dbflute.exentity.*;
import com.example.dbflutetest.dbflute.bsentity.dbmeta.*;
...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Member> selectByPK(Long id) {
        return facadeSelectByPK(id);
    }

    protected OptionalEntity<Member> facadeSelectByPK(Long id) {
        return doSelectOptionalByPK(id, typeOfSelectedEntity());
    }

    protected <ENTITY extends Member> ENTITY doSelectByPK(Long id, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(id), tp);
    }

    protected <ENTITY extends Member> OptionalEntity<ENTITY> doSelectOptionalByPK(Long id, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(id, tp), id);
    }

    protected MemberCB xprepareCBAsPK(Long id) {
     ...
     */
    public List<Long> extractIdList(List<Member> memberList)
