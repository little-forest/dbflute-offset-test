package com.example.dbflutetest.dbflute.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="com.example.dbflutetest.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.example.dbflutetest.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.example.dbflutetest.dbflute.allcommon.ImplementedInvokerAssistant();
    }
